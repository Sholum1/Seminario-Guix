...
\end{frame}
\begin{frame}[label={sec:org856c09b}]{Exemplo:}
...
\end{minipage}
\end{frame}
\begin{frame}[label={sec:org503e348},fragile]{Mas isso não ocupa muito armazenamento?}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org2879c75},fragile]{Guix permite mais!}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orga410dfe},fragile]{Guix ainda permite mais!}
...
\end{frame}
\begin{frame}[label={sec:org36fc52f},fragile]{Mas e o Sistema Operacional?}
...
\end{frame}
\begin{frame}[label={sec:org4b115ee},fragile]{Guix System}
...
\end{frame}
\begin{frame}[label={sec:orgfffe22a},fragile]{⁤}
