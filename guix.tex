...
\end{frame}
\begin{frame}[label={sec:orgc221287}]{Exemplo:}
...
\end{minipage}
\end{frame}
\begin{frame}[label={sec:org9dc9918},fragile]{Mas isso não ocupa muito armazenamento?}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org84a78f9},fragile]{Guix permite mais!}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org75e53f6},fragile]{Guix ainda permite mais!}
...
\end{frame}
\begin{frame}[label={sec:orga05631c},fragile]{Mas e o Sistema Operacional?}
...
\end{frame}
\begin{frame}[label={sec:orgcb9e907},fragile]{Guix System}
...
\end{frame}
\begin{frame}[label={sec:orga7705db},fragile]{⁤}
