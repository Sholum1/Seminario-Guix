...
\maketitle
\begin{frame}[label={sec:org85ebfd6}]{O que é o projeto GNU?}
...
\end{frame}
\begin{frame}[label={sec:org4d8f8f7}]{O que é GNU Guix?}
...
programação.
\end{frame}
\begin{frame}[label={sec:org48f0e15},fragile]{O que é um gerenciador de pacotes transacional?}
...
\end{frame}
\begin{frame}[label={sec:org4d710d7}]{Exemplo:}
...
\end{minipage}
\end{frame}
\begin{frame}[label={sec:org4c6702e},fragile]{Mas isso não ocupa muito armazenamento?}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org465e79d},fragile]{Guix permite mais!}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgb24caf0},fragile]{Guix ainda permite mais!}
...
\end{frame}
\begin{frame}[label={sec:org727efdc},fragile]{Mas e o Sistema Operacional?}
...
\end{frame}
\begin{frame}[label={sec:org7524dd4},fragile]{Guix System}
...
\end{frame}
\begin{frame}[label={sec:org657503c},fragile]{⁤}
...
\end{frame}
\begin{frame}[label={sec:org64e9200},fragile]{⁤}
...
\end{frame}
\begin{frame}[label={sec:org1611277},fragile]{Seu sistema Guix é replicável e de fácil redistribuição!}
...
\end{frame}
\begin{frame}[label={sec:org82d885e},fragile]{Mais contêineres}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org2537563}]{Mas como tudo isso é configurado?}
...
\end{frame}
\begin{frame}[label={sec:orgca3a469}]{⁤}
...
\end{minipage}
\end{frame}
\begin{frame}[label={sec:org0f77e5c}]{Por que Guile?}
...
merecem destaque:
\end{frame}
\begin{frame}[label={sec:orga753e9f}]{⁤}
\begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org7953b11}]{Outras linguagens dentro do Guile}
...
\end{frame}
\begin{frame}[label={sec:orgb557cb3}]{Aplicações práticas:}
...
\end{frame}
\begin{frame}[label={sec:orge7db0dd},fragile]{⁤}
...
\end{frame}
\begin{frame}[label={sec:org23a3ccf}]{⁤}
...
abaixo:
\end{frame}
\begin{frame}[label={sec:org966245d}]{⁤}
\begin{center}
\includegraphics[height=220]{./Deploy.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org111464c}]{⁤}
\begin{center}
